      ...
      <div>
        ...
        <section id="title">
          ...
          <form id="search" className="byid" onSubmit={this.handleSearch}>
            <input
              type="text"
              placeholder="Enter the exact name product  eg Men Loafers"
              name="search"
              id="filter2"
            />
        ...
        {this.props.product ? (
          <div id="aproduct" className="article2 clearfix">
            <section>{this.extract(this.props.product.data.imgs)}</section>
            <section>
              ...
              <br />
              <span className="note2">
                product Name : {this.props.product.data.productname}
              </span>
              <br />
              <span className="note">
              ...
              <br />
              <span className="note2">
                Quantity : {this.props.product.data.quantity} in stock
              </span>
              <br />
              <span className="note2">
                Minimum : {this.props.product.data.minimum} Allowed in stock
              </span>
              <br />
              <span className="note2">
                Date Added : {this.props.product.data.created_date}{' '}
              </span>
              <br />
              <hr />
              <br />
              <span className="note">
                Description : {this.props.product.data.description}{' '}
              </span>
              <br />
            </section>
          </div>
        ...
        <div id="allproduct" className="article clearfix">
          {this.props.payload ? (
            this.props.payload.map(product => {
              ...
              const altvalue = regex2.exec(getalt)
                ? regex2.exec(getalt)[1]
                : ' ';
              ...
              return (
                <div key={productname}>
                  <section>
                    ...
                    <span className="note2">{id}</span>
                    <br />
                    <span className="note2">{productname}</span>
                    <br />
                    <span className="note">#{price}</span>
                    <br />
                    <span className="note2">{quantity} in stock</span>
                    <br />
                    <button
                      onClick={() => {
