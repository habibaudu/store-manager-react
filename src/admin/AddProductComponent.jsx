      ...
      <Fragment>
        <div>
          ...
          <div className="addbox">
            {status === constants.ADDING_PRODUCT && 'please wait ...'}
            {status === constants.PRODUCT_SUCESSFULLY_ADDED && (
              <div>
                products Added successfully. <Redirect to="/admin" />{' '}
              </div>
            )}
            ...
            <br />
            <p>
              Fill all fields in the form below and click submit or cancel to go
              back
            </p>
            <br />
            <br />
            <form onSubmit={this.onFormSubmit}>
              ...
              <label id="#bb">
                {' '}
                choose image
                <input type="file" name="profilepix" id="img" />
              </label>
              <textarea
                name="description"
                id="description"
              ...
              <br />
              <br />
              <Link to="/admin" className="cancelproduct">
                Cancel
              </Link>
              <br />
              <br />
